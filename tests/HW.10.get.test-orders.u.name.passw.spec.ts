...
test('get order with correct name&password  should receive code 200', async ({ request }) => {
...
test('get order with incorrect name=123 & correct password  should receive code 400', async ({
  request,
}) => {
  const response = await request.get(
...
test('get order with incorrect name= & correct password  should receive code 400', async ({
  request,
}) => {
  const response = await request.get(
...
test('get order without name & correct password should receive code 500', async ({ request }) => {
  const response = await request.get(
...
test('get order with correct name & without password should receive code 500', async ({
  request,
}) => {
  const response = await request.get(
